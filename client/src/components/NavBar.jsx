      ...
      >
        ...
        <div className="flex items-center gap-6 relative">
          <div className="relative">
           ...
           {
            showCreditPopup&&(
              <div className="w-64 absolute right-[-50px] mt-3 bg-white shadow-xl border border-gray-200 rounded-lg p-5 z-50">
           ...
           <button onClick={()=>{
            ...
            setShowCreditPopup(false)
           }} className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-full text-md hover:bg-gray-200 transition">
