          ...
          <div className="space-y-5">
            {[
              ...
              <motion.div
                ...
                className="felx items-center space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer"
              >
                {item.icon}
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <select
              ...
              value={mode}
              className="w-full py-3 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 ouline-none tarnsition"
            >
