      ...
      shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
          ...
          <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
               <div className='w-full max-w-md rounded-2xl overflow-hidden shadow-xl'>   
                ...
                {/** subtitle pending */}
                {subtitle&&(
                  <div className='w-full max-w-md bg-gray-50 border-gray-200
                ...
                <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
                     ...
                     <div className='grid grid-cols-2 gap-6 text-center'>
                      ...
                      <div>
                        ...
                        <span className='text-xs text-gray-400'>Toatal Questions</span>
                      </div>
          ...
          <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
            ...
            <textarea
              ...
              {!feedback?(
                ...
                whileTap={{scale:0.9}}
                 className='flex-1 disabled:bg-gray-500 bg-gradient-to-r  from-emerald-600 to-teal-500 
                ...
                >
                  ...
                  <button onClick={handleNext}
                   className='w-full flex items-center justify-center bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md
